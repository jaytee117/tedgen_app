...
<div class="tab-content" id="myTabContent">
        ...
        <div class="col-md-9">
            <div class="row">
                <input type="hidden" id="account_id" name="account_id"
                    value="{{ old('account_id', isset($site->id) ? $site->account_id : $customer->id) }}" required>
    ...
    <button type="submit" class="btn mt-4 float-end">{{ isset($site->id) ? 'Update Site' : 'Create Site' }}</button>
    <!--validation-->
    @if ($errors->any())
