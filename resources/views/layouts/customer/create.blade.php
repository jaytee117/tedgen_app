            ...
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                ...
                <div class="row">
                    ...
                    <label for="vat_number" class="col-md-3">VAT Number:
                        <input class="form-control" type="text" id="vat_number" name="vat_number"
                ...
                <div class="row">
                    ...
                    <label for="address_3" class="col-md-3">Address Line 3:
                        <input class="form-control" type="text" id="address_3" name="address_3"
                ...
                <div class="row">
                    <label for="telephone_1" class="col-md-3">Telephone Number:
                        <input class="form-control" type="text" id="telephone_1" name="telephone_1"
                    ...
                    <label for="telephone_2" class="col-md-3">Second Telephone Number:
                        <input class="form-control" type="text" id="telephone_2" name="telephone_2"
                ...
                <div class="pt-10">
                    <button type="submit"
                        class="btn btn-primary btn-block float-end">{{ isset($customer->id) ? 'Update Customer' : 'Create Customer' }}</button>
