    ...
    <div class="container-fluid px-4">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        ...
                        <div class="row">
                            ...
                            <label for="site_name" class="col-md-4">Site Name:
                                <input class="form-control" type="text" id="site_name" name="site_name"
                                    value="{{ old('site_name', isset($site->id) ? $site->site_name : '') }}" required>
                            </label>
                            <label for="site_telephone" class="col-md-4">Site Telephone:
                                <input class="form-control" type="text" id="site_telephone" name="site_telephone"
                ...
                <div class="row">
                    ...
                    <label for="current_temp" class="col-md-3">Current Temp:
                        <input class="form-control" type="text" id="current_temp" name="current_temp"
                            value="{{ old('current_temp', isset($site->id) ? $site->current_temp : '') }}">
                    </label>
                    <label for="weather_icon" class="col-md-3">Weather Icon:
                        <input class="form-control" type="text" id="weather_icon" name="weather_icon"
                ...
                <div class="pt-10">
                    <button type="submit"
                        class="btn btn-primary btn-block float-end">{{ isset($site->id) ? 'Update Site' : 'Create Site' }}</button>
            ...
            <div class="tab-pane fade" id="chp" role="tabpanel" aria-labelledby="chp-tab">
                @if (isset($site))
                    <a href="{{ route('installation.create', $site->id) }}" class="btn-success float-end">Add an
                        Installation</a>
